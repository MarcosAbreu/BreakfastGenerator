...
const prepCheckboxes = [document.getElementById("fstCheckItem"),
...
btnAddNewMeal.addEventListener('click',()=>{
    let meal = {
        ...
        "measurement": formNewMeal.elements["id-meal-measurement-field"].options[formNewMeal.elements["id-meal-measurement-field"].selectedIndex].value,
...
function configureNewMealElements(){  
    if( (divIngCont.clientHeight+26) >= divListContainer.clientHeight/2 ){ 
        ...
        let tempValue = divListContainer.clientHeight - divIngCont.clientHeight - divStepsCont.children[0].clientHeight -72;
        if(stList.clientHeight > tempValue ){
            stList.style.maxHeight = tempValue.toString()+'px';
            stList.style.overflowY = "scroll";
        }
...
function generateBreakfast() {
    if (prepCheckboxes[0].checked == false && prepCheckboxes[1].checked == false && prepCheckboxes[2].checked == false) {
        ...
        let resultArray = [ getRandomItem(group1), getRandomItem(group2), getRandomItem(group3), getRandomItem(group4)];
    ...
    for (let index = 0; index < 4; index++) {
        resultGrid.innerHTML += `
            <div class="result-item">
                <img src="` + arr[index].src + `" alt="`+ arr[index].name +`">
                <div class="result-item-info">
                    <label>`+ arr[index].name +`</label>
                    <div class="result-suggestion">
                        <i class="bi bi-layers"></i>
                        <p>` + arr[index].amount +` `+ arr[index].measurement + `</p>
                    </div>
                ...
                <div class="recipe-grid">
                    <div class="recipe-prep-time">
                        ...
                        <div>
                            ...
                            <label>` + objMeal.preparation + ` minutes</label>
                        </div>
                    </div>
                    <div class="recipe-amount">
                        ...
                        <div>
                            <i class="bi bi-layers"></i>
                            <label>` + objMeal.amount + ` ` + objMeal.measurement + `</label>
                        </div>
                    </div>
                </div>
                <h4>Ingredients</h4>
                <ul class="recipe-ingredients">` + ingredientsHTML + `
                </ul>
                <h4>Steps</h4>
                <ul class="recipe-steps"> ` + stepsHTML + `
                </ul>
